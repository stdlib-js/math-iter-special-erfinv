...
```javascript
iterErfinv = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-erfinv@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-erfinv@umd/bundle.js"></script>
```
